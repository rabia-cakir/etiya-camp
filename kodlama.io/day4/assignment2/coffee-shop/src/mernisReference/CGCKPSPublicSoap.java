...
public class CGCKPSPublicSoap
{
    ...
    public CGCKPSPublicSoap(){}

    public CGCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CGCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CGCExtendedSoapSerializationEnvelope envelope= new CGCExtendedSoapSerializationEnvelope(CGCExtendedSoapSerializationEnvelope.VER11);
