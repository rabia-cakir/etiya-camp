...
public class CGCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CGCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CGCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CGCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CGCDateTimeConverter dateTimeConverter = new CGCStandardDateTimeConverter();

    public CGCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CGCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CGCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CGCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CGCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CGCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
