...
public class MBPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MBPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MBPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MBPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MBPDateTimeConverter dateTimeConverter = new MBPStandardDateTimeConverter();

    public MBPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MBPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MBPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MBPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MBPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MBPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
