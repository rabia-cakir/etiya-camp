...
public class MBPKPSPublicSoap
{
    ...
    public MBPKPSPublicSoap(){}

    public MBPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MBPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MBPExtendedSoapSerializationEnvelope envelope= new MBPExtendedSoapSerializationEnvelope(MBPExtendedSoapSerializationEnvelope.VER11);
